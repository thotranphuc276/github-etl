...
class GitHubLoader:
    ...
    def _load_repository(self, session, repository_data):
        """
    ...
    def _load_committers(self, session, committers_data):
        """
    ...
    def _load_authors(self, session, authors_data):
        """
    ...
    def _load_commits(self, session, commits_data, repository, committers_map, authors_map):
        """
